Function createchunk.chunk(arg0%, arg1#, arg2#, arg3#, arg4%)
    ...
    If (arg0 > $FFFFFFFF) Then
        local0\Field4 = getiniint(scpmodding_processfilepath("Data\1499chunks.INI"), ("chunk" + (Str arg0)), "count", $00)
        ...
        Next
    EndIf
    local0\Field7 = copyentity(playerroom\Field19[$00], local0\Field6)
