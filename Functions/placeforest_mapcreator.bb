    ...
    For local0 = $00 To $09 Step $01
        For local1 = $00 To $09 Step $01
            If (arg0\Field3[((local1 * $0A) + local0)] > $00) Then
                local3 = $00
                local14 = $00
                local3 = (Int ceil(((Float arg0\Field3[((local1 * $0A) + local0)]) / 4.0)))
                If (local3 = $06) Then
                    local3 = $02
                EndIf
                local14 = ((arg0\Field3[((local1 * $0A) + local0)] Mod $04) * $5A)
                ...
                If (local3 > $00) Then
                    ...
                    If ((((local1 Mod $03) = $02) And (local15[(Int floor((Float (local1 / $03))))] = $00)) <> 0) Then
                        ...
                        local16 = createitem(("Log #" + (Str (Int (floor((Float (local1 / $03))) + 1.0)))), "paper", 0.0, 0.5, 0.0, $00, $00, $00, 1.0, $00)
                            ...
                            If (colorred() > rand($64, $104)) Then
                                ...
                                Select rand($00, $07)
                                    Case $00,$01,$02,$03,$04,$05,$06
                                        ...
                                        local7 = rnd(0.25, 0.4)
                                        For local9 = $00 To $03 Step $01
                                            local22 = copyentity(arg0\Field1[$04], $00)
                ...
                EndIf
                If (6.0 = ceil(((Float arg0\Field3[((local1 * $0A) + local0)]) / 4.0))) Then
                    For local9 = $00 To $01 Step $01
                        If (arg0\Field6[local9] = $00) Then
                            ...
                            local23 = copyentity(arg4\Field19[$02], arg0\Field6[local9])
                            positionentity(local23, 0.0, (32.0 * roomscale), 0.0, $01)
                            scaleentity(local23, (48.0 * roomscale), (45.0 * roomscale), (48.0 * roomscale), $01)
                            entityparent(local23, arg0\Field7[local9], $01)
                            entitytype(arg0\Field7[local9], $01, $00)
                            entitypickmode(arg0\Field7[local9], $02, $01)
                            positionentity(arg0\Field7[local9], (((Float local0) * local2) + arg1), arg2, (((Float local1) * local2) + arg3), $01)
                            rotateentity(arg0\Field7[local9], 0.0, (Float (local14 + $B4)), 0.0, $00)
                            moveentity(arg0\Field7[local9], 0.0, 0.0, -6.0)
