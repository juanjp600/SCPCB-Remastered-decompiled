Function destroyforest%(arg0.forest)
    ...
    For local0 = $00 To $09 Step $01
        For local1 = $00 To $09 Step $01
            If (arg0\Field4[((local1 * $0A) + local0)] <> $00) Then
                freeentity(arg0\Field4[((local1 * $0A) + local0)])
                arg0\Field4[((local1 * $0A) + local0)] = $00
    ...
    If (arg0\Field6[$01] <> $00) Then
        ...
        arg0\Field6[$00] = $01
    EndIf
    If (arg0\Field7[$00] <> $00) Then
        freeentity(arg0\Field7[$00])
        arg0\Field7[$00] = $00
    EndIf
    If (arg0\Field7[$01] <> $00) Then
        freeentity(arg0\Field7[$01])
        arg0\Field7[$01] = $00
    EndIf
    ...
    For local2 = $00 To $09 Step $01
        If (arg0\Field2[local2] <> $00) Then
            freeentity(arg0\Field2[local2])
            arg0\Field2[local2] = $00
        EndIf
    Next
    Return $00
End Function
