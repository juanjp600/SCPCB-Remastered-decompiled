Function initfastresize%()
    ...
    entityfx(local1, $11)
    scaleentity(local1, (2048.0 / (Float realgraphicwidth)), (2048.0 / (Float realgraphicheight)), 1.0, $00)
    positionentity(local1, 0.0, 0.0, 1.0001, $00)
    entityorder(local1, $FFFE795F)
    entityblend(local1, $01)
    fresize_image = local1
    fresize_texture = createtexture($800, $800, $101, $01)
    fresize_texture2 = createtexture($800, $800, $101, $01)
