Function preventroomoverlap%(arg0.rooms)
    ...
    EndIf
    local2 = $00
    If ((((arg0\Field7\Field10 = "checkpoint1") Or (arg0\Field7\Field10 = "checkpoint2")) Or (arg0\Field7\Field10 = "room173")) <> 0) Then
        Return $01
    EndIf
    ...
    For local0 = Each rooms
        If (((local0 <> arg0) And (local0\Field7\Field18 = $00)) <> 0) Then
            If ((((arg0\Field7\Field9 = local0\Field7\Field9) And (arg0\Field0 = local0\Field0)) And (((local0\Field7\Field10 <> "checkpoint1") And (local0\Field7\Field10 <> "checkpoint2")) And (local0\Field7\Field10 <> "room173"))) <> 0) Then
                local3 = (Int (arg0\Field3 / 8.0))
                local4 = (Int (arg0\Field5 / 8.0))
                local8 = arg0\Field6
