Function createmap%()
    ...
    maproom($01, $00) = "room173"
    setroom("room372", $01, (Int floor((0.1 * (Float local12[$00])))), local25, local26)
    setroom("room005", $01, (Int floor((0.3 * (Float local12[$00])))), local25, local26)
    setroom("room914", $01, (Int floor((0.35 * (Float local12[$00])))), local25, local26)
    setroom("room205", $01, (Int floor((0.5 * (Float local12[$00])))), local25, local26)
    setroom("room1archive", $01, (Int floor((0.6 * (Float local12[$00])))), local25, local26)
    ...
    setroom("room2posters", $02, (Int floor((0.15 * (Float local13[$00])))), local25, local26)
    setroom("room2scps3", $02, (Int floor((0.2 * (Float local13[$00])))), local25, local26)
    setroom("room447", $02, (Int floor((0.25 * (Float local13[$00])))), local25, local26)
    setroom("room2scps", $02, (Int floor((0.3 * (Float local13[$00])))), local25, local26)
    setroom("room2storage", $02, (Int floor((0.35 * (Float local13[$00])))), local25, local26)
    ...
    setroom("medibay2", $02, (Int floor((0.7 * (Float local13[$00])))), local25, local26)
    setroom("room1123", $02, (Int floor((0.75 * (Float local13[$00])))), local25, local26)
    ...
    maproom($04, (Int floor((0.9 * (Float local15[$00]))))) = "room3scps"
    maproom($03, (Int floor((0.2 * (Float local14[$00]))))) = "room066"
    ...
    setroom("room106", $01, (Int (floor((0.2 * (Float local12[$01]))) + (Float local12[$00]))), local25, local26)
    setroom("room096", $01, (Int (floor((0.3 * (Float local12[$01]))) + (Float local12[$00]))), local25, local26)
    setroom("room035", $01, (Int (floor((0.5 * (Float local12[$01]))) + (Float local12[$00]))), local25, local26)
    setroom("room895", $01, (Int (floor((0.6 * (Float local12[$01]))) + (Float local12[$00]))), local25, local26)
    local25 = local13[$00]
    local26 = ((local13[$00] + local13[$01]) - $01)
    maproom($02, (Int (floor((0.15 * (Float local13[$01]))) + (Float local13[$00])))) = "room409"
    maproom($02, (Int (floor((0.3 * (Float local13[$01]))) + (Float local13[$00])))) = "room2nuke"
    setroom("room2tunnel", $02, (Int (floor((0.4 * (Float local13[$01]))) + (Float local13[$00]))), local25, local26)
    setroom("room049", $02, (Int (floor((0.45 * (Float local13[$01]))) + (Float local13[$00]))), local25, local26)
    setroom("room008", $02, (Int (floor((0.5 * (Float local13[$01]))) + (Float local13[$00]))), local25, local26)
    setroom("room2shaft", $02, (Int (floor((0.6 * (Float local13[$01]))) + (Float local13[$00]))), local25, local26)
    setroom("room2testroom", $02, (Int (floor((0.7 * (Float local13[$01]))) + (Float local13[$00]))), local25, local26)
    setroom("room2servers", $02, (Int (floor((0.9 * (Float local13[$01]))) + (Float local13[$00]))), local25, local26)
    maproom($02, (Int (floor((0.8 * (Float local13[$01]))) + (Float local13[$00])))) = "room457"
    maproom($04, (Int (floor((0.3 * (Float local15[$01]))) + (Float local15[$00])))) = "room513"
    maproom($04, (Int (floor((0.4 * (Float local15[$01]))) + (Float local15[$00])))) = "room009"
    maproom($04, (Int (floor((0.6 * (Float local15[$01]))) + (Float local15[$00])))) = "room966"
    maproom($03, (Int (floor((0.2 * (Float local14[$01]))) + (Float local14[$00])))) = "room650"
    maproom($03, (Int (floor((0.64 * (Float local14[$01]))) + (Float local14[$00])))) = "room2cpit"
    maproom($01, (((local12[$00] + local12[$01]) + local12[$02]) - $03)) = "gateb"
    maproom($01, (((local12[$00] + local12[$01]) + local12[$02]) - $02)) = "gateaentrance"
    maproom($01, (((local12[$00] + local12[$01]) + local12[$02]) - $01)) = "room1office"
    ...
    setroom("room2sroom", $02, (Int (floor((0.35 * (Float local13[$02]))) + (Float local25))), local25, local26)
    maproom($02, (Int (floor((0.35 * (Float local13[$02]))) + (Float local25)))) = "room2bio"
    ...
    maproom($02, (Int (floor((0.55 * (Float local13[$02]))) + (Float local25)))) = "room2offices5"
    ...
    maproom($04, (Int ((Float (local15[$00] + local15[$01])) + floor((0.5 * (Float local15[$02])))))) = "room3servers2"
    maproom($04, (Int ((Float (local15[$00] + local15[$01])) + floor((0.7 * (Float local15[$02])))))) = "room3offices"
    maproom($04, (Int ((Float (local15[$00] + local15[$01])) + floor((0.9 * (Float local15[$02])))))) = "room3offices2"
    local2 = $00
    local28 = 8.0
    local1 = (mapheight - $01)
    While (local1 >= $01)
    ...
    If (introenabled <> 0) Then
        local27 = createroom($00, $01, 8.0, 0.0, (Float ((mapheight - $01) Shl $03)), "room173intro")
        maproomid($01) = (maproomid($01) + $01)
    EndIf
    ...
    For local27 = Each rooms
        local27\Field6 = (Int wrapangle((Float local27\Field6)))
        local27\Field24[$00] = Null
        local27\Field24[$01] = Null
        local27\Field24[$02] = Null
        local27\Field24[$03] = Null
            ...
            If (local27 <> local34) Then
                If (local27\Field5 = local34\Field5) Then
                    If ((local27\Field3 + 8.0) = local34\Field3) Then
                        local27\Field24[$00] = local34
                        If (local27\Field25[$00] = Null) Then
                            local27\Field25[$00] = local34\Field25[$02]
                        EndIf
                    ElseIf ((local27\Field3 - 8.0) = local34\Field3) Then
                        local27\Field24[$02] = local34
                        If (local27\Field25[$02] = Null) Then
                            local27\Field25[$02] = local34\Field25[$00]
                        EndIf
                    EndIf
                ElseIf (local27\Field3 = local34\Field3) Then
                    If ((local27\Field5 - 8.0) = local34\Field5) Then
                        local27\Field24[$01] = local34
                        If (local27\Field25[$01] = Null) Then
                            local27\Field25[$01] = local34\Field25[$03]
                        EndIf
                    ElseIf ((local27\Field5 + 8.0) = local34\Field5) Then
                        local27\Field24[$03] = local34
                        If (local27\Field25[$03] = Null) Then
                            local27\Field25[$03] = local34\Field25[$01]
                        EndIf
                    EndIf
                EndIf
            EndIf
            If (((((local27\Field24[$00] <> Null) And (local27\Field24[$01] <> Null)) And (local27\Field24[$02] <> Null)) And (local27\Field24[$03] <> Null)) <> 0) Then
                Exit
            EndIf
        Next
    Next
