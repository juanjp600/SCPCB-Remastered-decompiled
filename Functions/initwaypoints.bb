Function initwaypoints%(arg0%)
    ...
    For local1 = Each waypoints
        ...
        local13 = (local13 + $01)
        If (local13 = $14) Then
            drawloading((Int (floor(((35.0 / local11) * (Float local12))) + (Float arg0))), $00)
            local13 = $00
        EndIf
        local2 = (After local1)
        local14 = $00
        While (local2 <> Null)
            If ((((local1\Field2 = local2\Field2) Or (local1\Field1 <> Null)) Or (local2\Field1 <> Null)) <> 0) Then
                ...
                If (((0.0 = local1\Field2\Field39) Or (0.0 = local2\Field2\Field39)) <> 0) Then
                    local14 = $01
                ElseIf (local1\Field2\Field39 >= (Abs (entityy(local1\Field0, $00) - entityy(local2\Field0, $00)))) Then
                    local14 = $01
                EndIf
                If (7.0 > local9) Then
                    If (local14 <> 0) Then
